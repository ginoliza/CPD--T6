 ...
 * 
 * Compile:  gcc -g -Wall -I. -o pth_ll_mult_mut pth_ll_mult_mut.c my_rand.c -lpthread
...
double      insert_percent = 0.1;
double      search_percent = 0.8;
double      delete_percent = 0.1;
